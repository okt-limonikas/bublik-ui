	...
	return (
		...
		>
			<div className="space-y-8">
				<SettingsSection title="Deploy Info" description="View deployment and environment details">
					<DeployInfoContainer />
				</SettingsSection>
				<SettingsSection title="Performance" description="Monitor system performance metrics">
