	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<button
					className={cn(
						'h-10 justify-start gap-3 rounded-lg pr-2.5 text-text-menu shadow-none transition-all duration-200',
			...
			<DialogPortal>
				<DialogContent
					className={cn(
						'h-[560px] w-[92vw] z-50 bg-white rounded-xl max-w-[860px] overflow-hidden p-0 shadow-2xl',
						dialogContentStyles()
					)}
				>
