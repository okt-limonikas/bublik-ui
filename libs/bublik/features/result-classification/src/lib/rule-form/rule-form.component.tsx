		...
		<>
			...
			<FormSection className="flex flex-col">
				...
				<div className="flex flex-col gap-4">
					...
					{/*
					 * Options are labelled `Test #42` and cover only tests some rule
					 * already targets — `/issue_rules/` returns no `test_name`, and a
					 * rules listing is the only place the UI sees a test id at all.
					 * See `docs/classification-api-gaps.md`.
					 */}
